...
define HOST_RUST_CONFIGURE_CMDS
	( \
		...
		echo 'python = "$(HOST_DIR)/bin/python3"'; \
...
define HOST_RUST_BUILD_CMDS
	cd $(@D); $(HOST_MAKE_ENV) $(HOST_DIR)/bin/python3 x.py build
endef

define HOST_RUST_INSTALL_CMDS
	cd $(@D); $(HOST_MAKE_ENV) $(HOST_DIR)/bin/python3 x.py dist
	cd $(@D); $(HOST_MAKE_ENV) $(HOST_DIR)/bin/python3 x.py install
endef
